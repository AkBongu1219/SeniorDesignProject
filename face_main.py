...
if __name__ == "__main__":
    ...
    recognizer.read('/Users/akhilbongu/Documents/trainer.yml')
    print(recognizer)
    # Path to the Haar cascade file for face detection
    face_cascade_Path = "/Users/akhilbongu/Documents/haarcascade_frontalface_default.xml"
    ...
    names = ['None']
    with open('/Users/akhilbongu/Documents/names.json', 'r') as fs:
        names = json.load(fs)
