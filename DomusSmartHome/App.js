...
import FloatingChatButton from "./screens/FloatingChatButton"; // Import the FloatingChatButton
...
const HomeScreen = ({ navigation }) => (
  <SafeAreaView style={styles.container}>
    <View style={styles.innerContainer}>
      ...
      <Button title="Go to Sensor Data" onPress={() => navigation.navigate("SensorData")} />
      <Button title="Go to Theft Detection" onPress={() => navigation.navigate("TheftDetection")} />
      <Button title="Go to Smart Plug" onPress={() => navigation.navigate("SmartPlug")} />
    </View>
